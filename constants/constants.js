  ...
  const bottom_tabs = [
    {
      id: 0,
      label: screens.home,
      icon: require("../assets/search2.jpeg")
    },
    {
      id: 1,
      label: screens.search,
      icon: require("../assets/th.jpeg")
    },
    {
      id: 2,
      label: screens.profile, // Change "screens.sports" to "screens.profile"
      icon: require("../assets/prof.jpeg")
    }
  ]
